...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/choose-restaurant/choose-restaurant.module').then(
        (m) => m.ChooseRestaurantPageModule
      ),
  },
  {
    path: 'add-review',
  ...
  },
  {
    path: 'select-drivers',
    loadChildren: () =>
      import('./pages/select-drivers/select-drivers.module').then(
        (m) => m.SelectDriversPageModule
      ),
  },
  {
    path: 'inbox',
  ...
  },
  {
    path: 'rate',
    loadChildren: () =>
      import('./pages/rate/rate.module').then((m) => m.RatePageModule),
  },
  {
    path: 'rest-details',
    loadChildren: () =>
      import('./pages/rest-details/rest-details.module').then(
        (m) => m.RestDetailsPageModule
      ),
  },
  {
    path: 'cities',
  ...
  },
  {
    path: 'variation',
    loadChildren: () =>
      import('./pages/variation/variation.module').then(
  ...
  },
  {
    path: 'variations',
    loadChildren: () =>
      import('./pages/variations/variations.module').then(
